...
# 76 "final_led_test.c" 2

# 1 "C:\\XC8_Compiler\\pic\\include\\c99\\string.h" 1 3
# 25 "C:\\XC8_Compiler\\pic\\include\\c99\\string.h" 3
# 1 "C:\\XC8_Compiler\\pic\\include\\c99\\bits/alltypes.h" 1 3
# 411 "C:\\XC8_Compiler\\pic\\include\\c99\\bits/alltypes.h" 3
typedef struct __locale_struct * locale_t;
# 25 "C:\\XC8_Compiler\\pic\\include\\c99\\string.h" 2 3
...
char *strerror (int);
# 65 "C:\\XC8_Compiler\\pic\\include\\c99\\string.h" 3
...
# 77 "final_led_test.c" 2
# 88 "final_led_test.c"
uint8_t print_buffer[33] = {0};

volatile uint8_t uart_char = 0;
volatile _Bool uart_rcv_data = 0;
...
void LCD_command_write(char data)
{
    LATB = data;
    LATDbits.LD3 = 0;
    LATDbits.LD4 = 0;
...
void reset_sim(void){
    ...
    if(reset_flag==1){
        while(1){
     _delay((unsigned long)((85)*(8000000/4000.0)));
